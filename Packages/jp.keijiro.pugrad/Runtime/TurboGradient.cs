...
// Google Turbo gradient functions
public static class TurboGradient
{
    public static Color Evaluate(float x)
    {
        TurboHelper.Evaluate(x, out float3 rgb);
...
static class TurboHelper
{
    ...
    [BurstCompile]
    public static void Evaluate(float x, out float3 rgb)
    {
