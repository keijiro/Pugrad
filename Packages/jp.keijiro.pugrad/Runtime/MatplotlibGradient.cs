...
// Matplotlib gradient functions
public static class ViridisGradient
{
    public static Color Evaluate(float x)
    {
        MatplotlibHelper.EvaluateViridis(x, out float3 rgb);
        return new Color(rgb.x, rgb.y, rgb.z);
    }
}

public static class PlasmaGradient
{
    public static Color Evaluate(float x)
    {
        MatplotlibHelper.EvaluatePlasma(x, out float3 rgb);
        return new Color(rgb.x, rgb.y, rgb.z);
    }
}

public static class MagmaGradient
{
    public static Color Evaluate(float x)
    {
        MatplotlibHelper.EvaluateMagma(x, out float3 rgb);
        return new Color(rgb.x, rgb.y, rgb.z);
    }
}

public static class InfernoGradient
{
    public static Color Evaluate(float x)
    {
        MatplotlibHelper.EvaluateInferno(x, out float3 rgb);
        return new Color(rgb.x, rgb.y, rgb.z);
    }
}
...
static class MatplotlibHelper
{
    ...
    [BurstCompile]
    public static void EvaluateViridis(float x, out float3 rgb)
    {
    ...
    [BurstCompile]
    public static void EvaluatePlasma(float x, out float3 rgb)
    {
        var v = math.float4(1, x, x * x, x * x * x);
    ...
    [BurstCompile]
    public static void EvaluateMagma(float x, out float3 rgb)
    {
        var v = math.float4(1, x, x * x, x * x * x);
    ...
    [BurstCompile]
    public static void EvaluateInferno(float x, out float3 rgb)
    {
        var v = math.float4(1, x, x * x, x * x * x);
